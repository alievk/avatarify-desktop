...
CHardwareSimulation *CHardwareSimulation::Initialize(IN KSOBJECT_BAG Bag, IN IHardwareSink *HardwareSink) {
    ...
    CHardwareSimulation *HwSim = new(NonPagedPoolNx, 'miSH') CHardwareSimulation(HardwareSink);
...
NTSTATUS CHardwareSimulation::Stop() {
    ...
    while (m_ScatterGatherMappingsQueued > 0) {
        ...
        PSCATTER_GATHER_ENTRY SGEntry = reinterpret_cast <PSCATTER_GATHER_ENTRY> (
...
ULONG CHardwareSimulation::ProgramScatterGatherMappings(IN PKSSTREAM_POINTER Clone, IN PUCHAR *Buffer,
    ...
    do {
        PSCATTER_GATHER_ENTRY Entry = reinterpret_cast <PSCATTER_GATHER_ENTRY> (
